...
These are Object Identifiers that tell the server what data you want to retrieve or modify. If you change the object identifier and retrieve or modify another user's private data, then this is an Insecure Direct Object Reference, or an IDOR for short. 
